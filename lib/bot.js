...
class Bot {
  constructor(options) {
    ...
    this.discordActivityStatus = options.discordActivityStatus;
    this.discordActivityType = options.discordActivityType;
  ...
  attachListeners() {
    this.discord.on('ready', () => {
      ...
      logger.info("Setting activity values: [name: " + this.discordActivityStatus + ", options.type: " + this.discordActivityType);
      this.discord.user.setActivity(this.discordActivityStatus, { type: this.discordActivityType });
    });
